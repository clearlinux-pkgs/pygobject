...
Source0  : https://download.gnome.org/sources/pygobject/3.48/pygobject-3.48.1.tar.xz
...
%prep
%setup -q -n pygobject-3.48.1
cd %{_builddir}/pygobject-3.48.1
pushd ..
cp -a pygobject-3.48.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710897735
...
/usr/lib/python3.12/site-packages/PyGObject-3.48.1.egg-info

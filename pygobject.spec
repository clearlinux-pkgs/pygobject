...
Source0  : https://download.gnome.org/sources/pygobject/3.42/pygobject-3.42.0.tar.xz
...
%prep
%setup -q -n pygobject-3.42.0
cd %{_builddir}/pygobject-3.42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632407256
...
cp %{_builddir}/pygobject-3.42.0/COPYING %{buildroot}/usr/share/package-licenses/pygobject/597bf5f9c0904bd6c48ac3a3527685818d11246d
cp %{_builddir}/pygobject-3.42.0/docs/images/LICENSE %{buildroot}/usr/share/package-licenses/pygobject/37e8ad1b8f297bce2b0974196aa6998cc7f8e418
